...
def main():
    ...
    p.add_argument('--groups', nargs='+', default=['final-models', 'protein-features'])
    p.add_argument('--manifest', type=Path, default=ROOT / 'configs/downloads/final_artifacts_20260920.json')
