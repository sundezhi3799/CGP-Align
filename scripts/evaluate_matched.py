...
def main():
 ...
 for method in a.methods:
  ...
  cmd=[sys.executable,str(root/'scripts/eval_matched_benchmark.py'),'--prepared',str(prepared),'--checkpoint',str(ck),'--method',method,'--output',str(a.output.resolve()/method),'--aggregation','mean_encoded','--replicate-data',str(a.artifacts.resolve()/f'data/seed{a.seed}/compound'),'--artifacts',str(a.artifacts.resolve()),'--device',a.device]
